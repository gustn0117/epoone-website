  ...
  return (
    <div>
      ...
      <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
        <Image src="/images/work-1.png" alt="에포원 에폭시 바닥재 시공 현장" fill className="object-cover scale-105" priority />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full glass-card mb-8 animate-fade-in">
              ...
              <span className="text-white/80 text-xs tracking-[0.25em] uppercase font-medium">Eco-Friendly Epoxy Flooring</span>
            </div>
