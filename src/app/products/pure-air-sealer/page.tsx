...
export default function PureAirSealerPage() {
  return (
    <SubpageLayout
      category="PRODUCTS"
      title="제품소개"
      ...
      tabs={tabs}
      activeTab="/products/pure-air-sealer"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">프로아 순에어 실러</h2>
          <p className="text-gray-500 text-sm mb-1">JEVISCO</p>
          <p className="text-gray-600 leading-relaxed mt-4">
            저취성 원료를 주성분으로 한 용제형 에폭시계 2액형 하도 도료로써 시공 시 발생하는 냄새를 최소화 하였으며 소지와의 부착성이
            우수하고 콘크리트 및 시멘트몰탈 소재에 깊이 침투하여 조립자를 고착화시키고 상도와의 층간 부착력을 향상시킵니다.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            <table className="w-full border-t-2 border-primary text-sm">
              <tbody>
                {[
                  ["사용 경화제", "프로아 순에어 실러 경화제"],
                  ["혼합비율(무게비)", "주제 : 경화제 = 1 : 1"],
                  ["추천건조도막(\u03bcm)", "50"],
                  ["이론도포면적(m\u00b2/kg)", "약 9.8 (건조도막 50\u03bcm 기준)"],
                  ["가사시간(20\u00b0C)", "90분"],
                  ["추천신나", "원액 사용"],
                  ["세척용 신나", "A 109 신나"],
                ].map(([key, val], i) => (
          ...
          <table className="w-full border-t-2 border-primary text-sm">
            ...
            <tbody>
              <tr className="border-b border-gray-100">
                ...
                <td className="py-3 px-4 text-gray-600">3시간</td>
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="py-3 px-4 text-gray-600">26시간</td>
                <td className="py-3 px-4 text-gray-600">18시간</td>
                <td className="py-3 px-4 text-gray-600">12시간</td>
                <td className="py-3 px-4 text-gray-600">9시간</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="w-full border-t-2 border-primary text-sm">
            ...
            <tbody>
              <tr className="border-b border-gray-100">
                ...
                <td className="py-3 px-4 text-gray-600">30시간</td>
                <td className="py-3 px-4 text-gray-600">18시간</td>
                <td className="py-3 px-4 text-gray-600">12시간</td>
                <td className="py-3 px-4 text-gray-600">8시간</td>
              </tr>
              <tr className="border-b border-gray-100">
                <td className="py-3 px-4 font-medium text-gray-700 bg-gray-50">재도장 간격(최고)</td>
                <td className="py-3 px-4 text-gray-600">14일</td>
                <td className="py-3 px-4 text-gray-600">10일</td>
                <td className="py-3 px-4 text-gray-600">7일</td>
        ...
        <div className="mb-16">
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <p className="text-sm text-gray-600">15kg (주제: 7.5kg, 경화제: 7.5kg)</p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-gray-50 rounded-xl p-6 space-y-2 text-sm text-gray-600">
            <p><strong className="text-gray-700">&lt;상도 도료&gt;</strong> 프로아 순에어 라이닝, 프로아 코팅</p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>2) 표면의 LAITANCE, 먼지, 유분 등 기타 오염물질을 완전히 제거해야 합니다. (샌드 블라스팅, 다이아몬드 휠 그라인딩 또는 10% HCl(염산) 산세척 등)</li>
                <li>3) 틈새나 홈은 에폭시계 퍼티인 &apos;프로아 에폭시 퍼티&apos;로 메꾼 후 표면을 조정합니다.</li>
              ...
              <table className="w-full text-sm border-t border-gray-200">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-2 px-3 text-gray-600">3mm</td>
              ...
              <div className="space-y-4 text-sm text-gray-600">
                <div>
                  ...
                  <ul className="space-y-1.5">
                    <li>1) 크랙이나 균열부위, 벽면과 바닥면의 접합부위는 하도 도장 전 &apos;프로아 에폭시 퍼티&apos;로 보강 합니다.</li>
                    <li>2) 바탕 처리가 끝난 후 &apos;프로아 순에어 실러&apos;의 주제와 경화제를 1:1(무게비)로 충분히 혼합하여 로울러 또는 붓으로 50\u03bcm, 1회 도장합니다.(원액 도장)</li>
                    <li>3) 후속 공정 표면의 기포 및 핀홀 현상 방지를 위해 누락 부위가 없어야 하며 부착 불량 방지를 위해 부분적으로 후도막이 되지 않도록 균일하게 도장합니다.</li>
                    <li>4) 1회 도장 시 도장면의 흡수가 심한 부분은 하도를 추가 도장합니다.</li>
                  </ul>
                </div>
                <div>
        ...
        <div>
          ...
          <div className="bg-red-50 rounded-xl p-6">
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>4) 혼합된 도료는 반드시 가사시간 내에 전량 사용하여야 하며, 특히 사용하던 잔량의 도료에 새로운 도료를 혼합하여 사용을 금합니다(가사시간이 급격히 짧아짐).</li>
